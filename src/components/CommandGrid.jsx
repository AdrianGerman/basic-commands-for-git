    ...
    <div className="grid grid-cols-3 gap-8 w-full max-w-7xl px-6 justify-center">
      <section className="flex flex-col gap-4">
        <Section
          ...
          emoji="🚀"
          columns={1}
          className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-md p-6 w-full h-full"
          commands={[
        ...
        <Section
          ...
          emoji="🌿"
          columns={2}
          className="bg-gray-800 rounded-xl shadow p-5 w-full h-fil"
          commands={[
      ...
      <section className="flex flex-col gap-4">
        <Section
          ...
          emoji="⚙️"
          columns={3}
          className="bg-gray-900 rounded-3xl shadow-lg p-8 w-full h-full"
          commands={[
        ...
        <Section
          ...
          emoji="🤝"
          columns={4}
          className="bg-gradient-to-tl from-gray-900 to-gray-700 rounded-2xl shadow-xl p-7 w-full h-full"
          commands={[
      ...
      <section className="flex flex-col gap-4">
        <Section
          ...
          emoji="🧹"
          columns={3}
          className="bg-gray-900 rounded-2xl shadow-lg p-6 w-full h-full"
          commands={[
        ...
        <Section
          ...
          emoji="✨"
          columns={3}
          className="bg-gray-800 rounded-3xl shadow-2xl p-8 w-full h-full"
          commands={[
